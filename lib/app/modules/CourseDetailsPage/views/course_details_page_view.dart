...
class CourseDetailsPageView extends GetView<CourseDetailsPageController> {
  const CourseDetailsPageView({Key? key}) : super(key: key);
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            "A Course by Text messaging, texting, is the act composing and sending electronic messages, consisting of alphabetic desktops/la…",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Kcolor.grey500),
                          ),
          ...
          Padding(
            padding:
                EdgeInsets.only(left: size.width * .055, top: size.height * .020),
            child: Material(
              elevation: 3,
